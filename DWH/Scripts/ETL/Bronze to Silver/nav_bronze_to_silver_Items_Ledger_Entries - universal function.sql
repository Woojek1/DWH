...
BEGIN
	...
	_tabela := format('nav_items_ledger_entries_%s', _firma);  --- ZMIENIĆ NAZWĘ TABELI ŹRÓDŁOWEJ I DOCELOWEJ ---
	...
	EXECUTE format($insert$
		...
		SELECT
			...
			,CASE
				...
				WHEN ile."Entry Type" = 2 THEN 'Positive Adjmt.'
				WHEN ile."Entry Type" = 3 THEN 'Negative Adjmt.'
			...
			,ile."Shipped Qty_ Not Returned"
			,NULL --ile."Reserved_Quantity"
			,NULL --ile."Sales_Amount_Expected"
			,NULL --ile."Sales_Amount_Actual"
			,NULL --ile."Cost_Amount_Expected"
			,NULL --ile."Cost_Amount_Actual"
			,CAST(ile."Completely Invoiced" AS boolean)
			,CAST(ile."Open" AS boolean)
			,NULL --ile."Order_Line_No"
			,NULL --ile."Prod_Order_Comp_Line_No"
			,NULL --ile."Dimension_Set_ID"
			,NULL --ile."Shortcut_Dimension_3_Code"
			,NULL --ile."Shortcut_Dimension_4_Code"
			,NULL --ile."Shortcut_Dimension_5_Code"
			,NULL --ile."Shortcut_Dimension_6_Code"
			,NULL --ile."Shortcut_Dimension_7_Code"
			,NULL --ile."Shortcut_Dimension_8_Code"
			,ile."Campaign No_"
			,NULL -- ile."EDN_Campaign_Description"
			,%L
        	,CURRENT_TIMESTAMP
		FROM bronze.%I ile
