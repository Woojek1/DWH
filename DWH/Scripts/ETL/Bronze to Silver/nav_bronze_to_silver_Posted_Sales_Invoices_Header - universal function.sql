...
--			,"Remaining_Amount"
		...
		SELECT
			ih."No_"
			,ih."Sell-to_CustomerNo_"
			,ih."Sell-to Customer Name"
			,REGEXP_REPLACE(ih."VAT Registration No_", '[^0-9A-Za-z]', '', 'g') AS "VAT_Registration_No"
			,ih."Sell-to Address"
			,ih."Sell-to Address 2"
			,INITCAP(TRIM(ih."Sell-to City"))
			,LOWER(TRIM(ih."Sell-to County"))
			,ih."Sell-to Post Code"
			,ih."Document Date"
			,ih."Posting Date"
			,ih."Due Date"
			,ih."Quote No_"
...
--			,ih."Remaining_Amount"
			...
			,ih."Payment Method Code"
			,ih."Shortcut Dimension 1 Code"
			,ih."Shortcut Dimension 2 Code"
			,ih."Customer Posting Group"
			,ih."Location Code"
			,ih."Shipment Method Code"
