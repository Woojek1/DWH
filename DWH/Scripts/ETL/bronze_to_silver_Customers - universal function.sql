...
BEGIN
	...
	EXECUTE format($sql$
		DROP TRIGGER IF EXISTS trg_upsert_bc_$1%s_$2%I ON bronze.bc_$1%s_$2%I;
		CREATE TRIGGER trg_upsert_bc_$1%s_$2%I
		AFTER INSERT OR UPDATE ON bronze.bc_$1%s_$2%I
		FOR EACH ROW
		EXECUTE FUNCTION bronze.fn_upsert_bc_$1%s('$2%L')
	$sql$, grupa_tabel, firma);
	END LOOP;
END;
$$ LANGUAGE plpgsql;
